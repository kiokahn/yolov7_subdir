...
Modified by cjpart, kiokahn    
하위 폴더 구조를 지원 가능하도록 수정 함  
중심 점 키포인트 출력    
출력 위치 : ./run/detect/exp["#"]      
On image:
``` shell
python detect.py --weights yolov7.pt --conf 0.25 --img-size 640 --source inference/images/horses.jpg
python detect.py --weights yolov7.pt --conf 0.25 --img-size 640 --save-txt --source data/soccer_trajectory_img/
```
